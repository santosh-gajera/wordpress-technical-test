...
CTFrontendBuilder.controller("ControllerShortcuts",["$scope","$parentScope","$timeout","$interval","$rootScope",function(e,o,t,a,r){var c,n,i,s=(c=function(e){if("true"==CtBuilderAjax.userCanFullAccess&&!e.originalEvent.repeat&&!o.isActiveActionTab("contentEditing")){var t=!1,a=e.key.toLowerCase();if(e.keyCode,!e.ctrlKey&&!e.metaKey||e.shiftKey){if((e.ctrlKey||e.metaKey)&&e.shiftKey)switch(a){case"c":o.copyElementExportJSON(o.iframeScope.component.active.id),t=!0;break;case"i":o.showImportModal(),t=!0}}else switch(a){case"s":o.triggerCodeMirrorBlur(),iframeScope.savePage(),t=!0;break;case"backspace":case"delete":iframeScope.removeActiveComponent(),t=!0;break;case"d":iframeScope.duplicateComponent(),t=!0;break;case"c":r.$broadcast("copyElement"),t=!0;break;case"v":r.$broadcast("pasteElement"),t=!0;break;case"z":iframeScope.undo();break;case"y":iframeScope.redo()}return!t&&void 0}},n=250,function(){var e=this,t=arguments;i&&clearTimeout(i),i=setTimeout(function(){i=null,c.apply(e,t)},n)});function l(e){if(["s","backspace","delete","d","c","v","z","y","i"].includes(e.key.toLowerCase())&&!(e.target.parentElement.classList.contains("textarea")&&"s"!=e.key.toLowerCase()||"INPUT"==e.target.nodeName&&"s"!=e.key.toLowerCase()||"TEXTAREA"==e.target.nodeName&&"s"!=e.key.toLowerCase()||o.isActiveActionTab("contentEditing")))return e.ctrlKey||e.metaKey?(s(e),!1):void 0}angular.element("body").on("keydown",l),parent.angular.element("body").on("keydown",l)}]);
CTFrontendBuilder.controller("ControllerAutoUnits",["$scope","$parentScope","$timeout","$interval","$rootScope",function(e,n,o,t,r){var a=[];function l(e){return"INPUT"==e.nodeName&&!!e.parentElement.querySelector(".oxygen-measure-box-units")}parent.angular.element("body").on("keyup",function(e){var r=e.target;l(r)&&a.length&&a.forEach(function(e){var n,o,t;r.value&&r.value.replace(/\d*\.?\d*/g,"")==e&&("none"==e&&(e=" "),o=(n=r).dataset.option,t=e,console.dir(n),n.attributes["ng-model"].nodeValue.includes("global")?iframeScope.setGlobalOptionUnit("global",o,t):iframeScope.setOptionUnit(o,t)," "==t&&(t="none"),n.value=n.value.replace(t,""),"none"!=t&&n.blur())})}).on("focusin",function(e){var n=e.target;l(n)&&(a=[],n.parentElement.querySelector(".oxygen-measure-box-units").querySelectorAll("div:not(.oxygen-measure-box-unit-active)").forEach(function(e){a.push(e.innerText.replace(/[\n\r]+|[\s]{2,}/g," ").trim())}))})}]);
