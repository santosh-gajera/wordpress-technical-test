...
<?php
	foreach($data as $key=>$value) {
    	echo "<tr>";
    	echo "<td><div class='wrap_icon_currency'><img src='".plugin_dir_url( __FILE__ )."images/".$value['symbol'].".png'/>".$value['symbol']." ".$value['name']."</div></td> <td>$".number_format($value['quote']['USD']['price'],2)."</td> <td>".sprintf("%01.2f",$value['quote']['USD']['percent_change_24h'])."%</td> <td>$".number_format($value['quote']['USD']['market_cap'])."M</td> <td>".$value['quote']['USD']['percent_change_7d']."</td>";
    	echo "</tr>";
